 ...
 * @Last modified time: 2018-12-24T01:47:14-06:00
  ...
  model(params){
    ...
    Ember.$.post(request_url, data).then(
      ...
      run =>{
        ...
        Ember.$.getJSON(config.host+'/api/v1/terms/get_pages', {namespace: params.namespace, goontology: params.goontology}).then(function(result){
