 ...
 * @Last modified time: 2022-01-18T12:11:38-06:00
...
export default Controller.extend({
  ...
  genelist: '',
  genelistValidation: [{
    message: 'Genes must be listed in a comma separated value format with no white spaces or line feed characters. e.g. gene1,gene2,...',
    validate: (inputValue) => {
  ...
  ontologyselected: computed('model',function(){
