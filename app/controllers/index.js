...
export default Controller.extend({
  ...
  actions: {
    geneformSubmit(){
      this.transitionToRoute('visualization', { queryParams: { geneids: this.get('genelist'), pvalue: this.get('pvaluethreshold'), clusters: this.get('numclusters'), organism: this.get('organismselected.code'), background: this.get('background') }})
    },
